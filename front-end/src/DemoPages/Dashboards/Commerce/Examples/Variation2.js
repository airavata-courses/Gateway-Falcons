                            ...
                            <Col md="12" lg="6" xl="5">
                                                            ...
                                                            <div className="widget-content-wrapper">
                                                                ...
                                                                <div className="widget-content-left">
                                                                    ...
                                                                    <div className="widget-subheading mt-1 opacity-10">
                                                                        <div className="badge badge-pill badge-primary">$152</div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div className="widget-content p-0">
                                                            <div className="widget-content-wrapper">
                                                                ...
                                                                <div className="widget-content-left">
                                                                    ...
                                                                    <div className="widget-subheading mt-1 opacity-10">
                                                                        <div className="badge badge-pill badge-primary">$53</div>
                                                                    </div>
                                                                </div>
                                                                <div className="widget-content-right">
                                                                    <div
                                                        ...
                                                        <div className="widget-content p-0">
                                                            <div className="widget-content-wrapper">
                                                                ...
                                                                <div className="widget-content-left">
                                                                    ...
                                                                    <div className="widget-subheading mt-1 opacity-10">
                                                                        <div className="badge badge-pill badge-primary">$239</div>
                                                                    </div>
                                                                </div>
                                                                <div className="widget-content-right">
                                                                    <div
                                                        ...
                                                        <div className="widget-content p-0">
                                                            <div className="widget-content-wrapper">
                                                                ...
                                                                <div className="widget-content-left">
                                                                    ...
                                                                    <div className="widget-subheading mt-1 opacity-10">
                                                                        <div className="badge badge-pill badge-primary">$21</div>
                                                                    </div>
                                                                </div>
                                                                <div className="widget-content-right">
                                                                    <div
                                                        ...
                                                        <div className="widget-content p-0">
                                                            <div className="widget-content-wrapper">
                                                                ...
                                                                <div className="widget-content-left">
                                                                    ...
                                                                    <div className="widget-subheading mt-1 opacity-10">
                                                                        <div className="badge badge-pill badge-primary">$381</div>
                                                                    </div>
                                                                </div>
                                                                <div className="widget-content-right">
                                                                    <div
                                                        ...
                                                        <div className="widget-content p-0">
                                                            <div className="widget-content-wrapper">
                                                                ...
                                                                <div className="widget-content-left">
                                                                    ...
                                                                    <div className="widget-subheading mt-1 opacity-10">
                                                                        <div className="badge badge-pill badge-primary">$74</div>
                                                                    </div>
                                                                </div>
                                                                <div className="widget-content-right">
                                                                    <div
                                                        ...
                                                        <div className="widget-content p-0">
                                                            <div className="widget-content-wrapper">
                                                                ...
                                                                <div className="widget-content-left">
                                                                    ...
                                                                    <div className="widget-subheading mt-1 opacity-10">
                                                                        <div className="badge badge-pill badge-primary">$7</div>
                                                                    </div>
                                                                </div>
                                                                <div className="widget-content-right">
                                                                    <div
                                ...
                                <Card className="main-card mb-3">
                                    <CardHeader className="rm-border">
                                        <div>
                                            <h6 className="menu-header-title text-capitalize text-primary">Monthly Statistics</h6>
                                        </div>
                                    </CardHeader>
                                                        ...
                                                        <div className="widget-chart-content">
                                                            <div className="widget-chart-flex">
                                                                <div className="widget-numbers">
                                                                    <div className="widget-chart-flex">
                                                                        <div>
                                                                            <small className="opacity-5 text-success">+</small>
                                                                            76
                                                                        </div>
                                                                        <div
                        ...
                        <Card className="main-card mb-3">
                            ...
                            <Table responsive hover striped borderless className="align-middle mb-0">
                                ...
                                <tr>
                                    ...
                                    <td className="text-center">
                                        <Button size="sm" className="btn-icon btn-icon-only" color="light" id={'PopoverCustomT-1'}
                                ...
                                <tr>
                                    ...
                                    <td className="text-center">
                                        <Button size="sm" className="btn-icon btn-icon-only" color="light" id={'PopoverCustomT-2'}
                                ...
                                <tr>
                                    ...
                                    <td className="text-center">
                                        <Button size="sm" className="btn-icon btn-icon-only" color="light" id={'PopoverCustomT-3'}
                                ...
                                <tr>
                                    ...
                                    <td className="text-center">
                                        <Button size="sm" className="btn-icon btn-icon-only" color="light" id={'PopoverCustomT-4'}
