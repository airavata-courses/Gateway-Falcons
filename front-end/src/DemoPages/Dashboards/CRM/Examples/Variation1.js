                            ...
                            <Col md="6" lg="4" xl="4">
                                <Card className="card-hover-shadow-2x mb-3">
                                    <CardHeader className="rm-border responsive-center text-left">
                                        <div>
                                            <h5 className="menu-header-title text-capitalize text-success">Received Messages</h5>
                                        </div>
                                    </CardHeader>
                                            ...
                                            <div className="widget-chart-wrapper widget-chart-wrapper-lg he-auto opacity-10 m-0">
                                                <ResponsiveContainer height={131}>
                                                    <AreaChart data={data3} margin={{top: -20, right: 0, left: 0, bottom: 0}}>
                                                        <Tooltip/>
                                                        <Area type='monotoneX' dataKey='uv' stroke='var(--success)' strokeWidth={3} fill='var(--success)' fillOpacity='.1'/>
                                                    </AreaChart>
                                                </ResponsiveContainer>
                                            </div>
                                        </div>
                                            ...
                                            <div className="widget-chart-wrapper widget-chart-wrapper-lg he-auto opacity-10 m-0">
                                                <ResponsiveContainer height={131}>
                                                    <AreaChart data={data2} margin={{top: -20, right: 0, left: 0, bottom: 0}}>
                                                        <Tooltip/>
                                                        <Area type='monotoneX' dataKey='uv' stroke='var(--danger)' strokeWidth={3} fill='var(--danger)' fillOpacity='.1'/>
                                                    </AreaChart>
                                                </ResponsiveContainer>
                                            </div>
                                        </div>
                                            ...
                                            <div className="widget-chart-wrapper widget-chart-wrapper-lg he-auto opacity-10 m-0">
                                                <ResponsiveContainer height={131}>
                                                    <AreaChart data={data} margin={{top: -20, right: 0, left: 0, bottom: 0}}>
                                                        <Tooltip/>
                                                        <Area type='monotoneX' dataKey='uv' stroke='rgba(255,255,255,.3)' strokeWidth={3} fill='rgba(255,255,255,.1)'/>
                                                    </AreaChart>
                                                </ResponsiveContainer>
                                            </div>
                                        </div>
