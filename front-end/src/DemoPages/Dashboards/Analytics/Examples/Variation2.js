                                    ...
                                    <div className="widget-chart-wrapper">
                                        <ResponsiveContainer width='100%' aspect={3.0 / 1.0}>
                                            <AreaChart data={data2}
                                                ...
                                                <Area type='monotoneX' dataKey='uv' strokeWidth='2' stroke='var(--danger)' fill='var(--danger)' fillOpacity='.3' />
                                            </AreaChart>
                                        </ResponsiveContainer>
                                    </div>
                                </div>
                                    ...
                                    <div className="widget-chart-wrapper">
                                        <ResponsiveContainer width='100%' aspect={3.0 / 1.0}>
                                            <AreaChart data={data123}
                                                       margin={{top: 0, right: 0, left: 0, bottom: 0}}>
                                                <Area type='stepAfter' dataKey='uv' strokeWidth='2' stroke='var(--info)' fill='var(--info)' fillOpacity='.4'/>
                                            </AreaChart>
                                        </ResponsiveContainer>
                                    </div>
                                </div>
