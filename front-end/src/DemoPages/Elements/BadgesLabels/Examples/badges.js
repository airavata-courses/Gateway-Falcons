                        ...
                        <Col lg="6">
                                ...
                                <CardBody>
                                    ...
                                    <div className="grid-menu grid-menu-3col">
                                        <Row className="no-gutters">
                                            <Col xl="4" sm="6">
                                                <Button className="btn-icon-vertical btn-square btn-transition" outline
                                                        color="primary">
                                            ...
                                            <Col xl="4" sm="6">
                                                <Button className="btn-icon-vertical btn-square  br-tr btn-transition"
                                                        outline
                                                        color="info">
                                            ...
                                            <Col xl="4" sm="6">
                                                <Button className="btn-icon-vertical btn-square  br-bl btn-transition"
                                                        outline
                                                        color="warning">
                            ...
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Row>
                                        <Col xl="4" sm="6">
                                            <Button className="btn-icon-vertical mb-3 btn-transition btn-block" outline
                                                    color="primary">
                                                <i className="lnr-license btn-icon-wrapper"> </i>
                                                <span
