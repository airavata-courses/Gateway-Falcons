                        ...
                        <Col lg="6">
                            ...
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <div>
                                        <a href="javascript:void(0);" className="avatar-icon-wrapper avatar-icon-xl">
                                            <div className="avatar-icon rounded">
                                                <img src={avatar1} alt=""/>
                                            </div>
                                        </a>
                                        <a href="javascript:void(0);" className="avatar-icon-wrapper avatar-icon-lg">
                                            <div className="avatar-icon rounded">
                                                <img src={avatar2} alt=""/>
                                            </div>
                                        </a>
                                        ...
                                        <a href="javascript:void(0);" className="avatar-icon-wrapper avatar-icon-sm">
                                            <div className="avatar-icon rounded">
                                                <img src={avatar4} alt=""/>
                                            </div>
                                        </a>
                                        <a href="javascript:void(0);" className="avatar-icon-wrapper avatar-icon-xs">
                                            <div className="avatar-icon rounded">
                                                <img src={avatar5} alt=""/>
                                            </div>
                                        </a>
                                    ...
                                    <b>Hover Shine</b>
                                    <div>
                                        <a href="javascript:void(0);" className="avatar-icon-wrapper btn-hover-shine avatar-icon-xl">
                                            <div className="avatar-icon rounded">
                                                <img src={avatar1} alt=""/>
                                            </div>
                                        </a>
                                        <a href="javascript:void(0);" className="avatar-icon-wrapper btn-hover-shine avatar-icon-lg">
                                            <div className="avatar-icon rounded">
                                                <img src={avatar2} alt=""/>
                                            </div>
                                        </a>
                                        <a href="javascript:void(0);" className="avatar-icon-wrapper btn-hover-shine">
                                            <div className="avatar-icon rounded">
                                                <img src={avatar3} alt=""/>
                                            </div>
                                        </a>
                                        <a href="javascript:void(0);" className="avatar-icon-wrapper btn-hover-shine avatar-icon-sm">
                                            <div className="avatar-icon rounded">
                                                <img src={avatar4} alt=""/>
                                            </div>
                                        </a>
                                        <a href="javascript:void(0);" className="avatar-icon-wrapper btn-hover-shine avatar-icon-xs">
                                            <div className="avatar-icon rounded">
                                                <img src={avatar5} alt=""/>
                                            </div>
                                        </a>
