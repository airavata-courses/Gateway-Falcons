                        ...
                        <Col md="12">
                            <Card tabs="true" className="mb-3">
                                ...
                                <TabContent activeTab={this.state.activeTab}>
                                    <TabPane tabId="1">
                                        <CardBody>
                                            <p className="mb-0">Lorem Ipsum has been the industry's standard dummy text ever since the
                                    ...
                                    <TabPane tabId="3">
                                        <CardBody>
                                            <p className="mb-0">It was popularised in the 1960s with the release of Letraset sheets
