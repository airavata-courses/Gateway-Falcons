...
const Glyphicons = () => (
  <Page>
    <PageTitle title="Glyphicons Icons"><GlobalSearch/></PageTitle>
    <Panel>
      <PanelHeader>
      ...
      <PanelBody>
        <div className="bs-docs-section">
          ...
          <p>Includes 260 glyphs in font format from the Glyphicon Halflings set. <a
            href="http://glyphicons.com/">Glyphicons</a> Halflings are normally not available for free, but their
            creator has made them available for Bootstrap free of cost.
          ...
          <div className="bs-glyphicons">
            <ul className="bs-glyphicons-list">
              ...
              <li>
                <span className="glyphicon glyphicon-euro" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-euro</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-eur" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-star-empty" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-volume-off" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-volume-off</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-volume-down" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-volume-down</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-volume-up" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-volume-up</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-qrcode" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-qrcode</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-barcode" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-tags" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-font" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-text-height" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-text-height</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-text-width" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-align-right" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-indent-left" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-indent-left</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-indent-right" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-indent-right</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-facetime-video" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-adjust" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-eject" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-resize-small" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-magnet" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-certificate" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-hand-right" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-hand-right</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-hand-left" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-hand-left</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-hand-up" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-hand-up</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-hand-down" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-circle-arrow-left" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-circle-arrow-down" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-gbp" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-sort-by-alphabet" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-sort-by-alphabet</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-sort-by-alphabet-alt" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-sort-by-alphabet-alt</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-sort-by-order" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-sort-by-order</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-sort-by-order-alt" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-sort-by-attributes-alt" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-floppy-saved" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-floppy-open" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-cutlery" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-cutlery</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-header" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-header</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-compressed" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-sd-video" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-sd-video</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-hd-video" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-hd-video</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-subtitles" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-subtitles</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-sound-stereo" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-sound-stereo</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-sound-dolby" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-sound-dolby</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-sound-5-1" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-sound-5-1</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-sound-6-1" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-sound-6-1</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-sound-7-1" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-registration-mark" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-cloud-upload" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-cloud-upload</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-tree-conifer" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-cd" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-cd</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-save-file" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-save-file</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-open-file" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-open-file</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-level-up" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-paste" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-equalizer" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-queen" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-queen</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-pawn" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-pawn</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-bishop" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-baby-formula" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-baby-formula</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-tent" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-lamp" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-bitcoin" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-bitcoin</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-yen" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-yen</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-ruble" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-ruble</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-scale" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-scale</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-ice-lolly" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-ice-lolly</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-ice-lolly-tasted" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-modal-window" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-modal-window</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-oil" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-oil</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-grain" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-grain</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-sunglasses" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-sunglasses</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-text-size" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-text-size</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-text-color" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-text-color</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-text-background" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-text-background</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-object-align-top" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-object-align-top</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-object-align-bottom" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-object-align-bottom</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-object-align-horizontal" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-object-align-horizontal</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-object-align-left" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-object-align-left</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-object-align-vertical" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-object-align-vertical</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-object-align-right" aria-hidden="true"/>
              ...
              <li>
                <span className="glyphicon glyphicon-superscript" aria-hidden="true"/>
                <span className="glyphicon-class">glyphicon glyphicon-superscript</span>
              </li>

              <li>
                <span className="glyphicon glyphicon-subscript" aria-hidden="true"/>
          ...
          <div className="bs-callout bs-callout-danger" id="callout-glyphicons-dont-mix">
            ...
            <p>Icon classes cannot be directly combined with other components. They should not be used along with other
              classes on the same element. Instead, add a nested <code>&lt;span&gt;</code> and apply the icon classes to
          ...
          <div className="bs-callout bs-callout-info" id="callout-glyphicons-location">
            ...
            <p>Bootstrap assumes icon font files will be located in the <code>../fonts/</code> directory, relative to
              the compiled CSS files. Moving or renaming those font files means updating the CSS in one of three ways:
            </p>
            <ul>
              <li>Change the <code>@icon-font-path</code> and/or <code>@icon-font-name</code> variables in the source
                Less files.
              </li>
              <li>Utilize the <a href="http://lesscss.org/usage/#command-line-usage-relative-urls">relative URLs
                option</a> provided by the Less compiler.
              </li>
          ...
          <div className="bs-callout bs-callout-warning" id="callout-glyphicons-accessibility">
            ...
            <p>Modern versions of assistive technologies will announce CSS generated content, as well as specific
              Unicode characters. To avoid unintended and confusing output in screen readers (particularly when icons
              are used purely for decoration),
              we hide them with the <code>aria-hidden="true"</code> attribute.</p>
            <p>If you're using an icon to convey meaning (rather than only as a decorative element), ensure that this
              meaning is also conveyed to assistive technologies – for instance, include additional content, visually
              hidden with the <code>.sr-only</code> class.</p>
            <p>If you're creating controls with no other text (such as a <code>&lt;button&gt;</code> that only contains
              an icon), you should always provide alternative content to identify the purpose of the control, so that it
              will make sense to
              users of assistive technologies. In this case, you could add an <code>aria-label</code> attribute on the
              control itself.</p>
          </div>
          <div className="zero-clipboard"><span className="btn-clipboard">Copy</span>
          </div>
          <div className="highlight">
            <pre><code className="language-html" data-lang="html"><span className="nt">&lt;span</span> <span
              className="na">class=</span><span className="s">"glyphicon glyphicon-search"</span> <span
          ...
          <div className="bs-example" data-example-id="glyphicons-general">
            <div className="btn-toolbar" role="toolbar">
              <div className="btn-group">
                <button type="button" className="btn btn-default" aria-label="Left Align"><span
                  className="glyphicon glyphicon-align-left" aria-hidden="true"/>
                </button>
                <button type="button" className="btn btn-default" aria-label="Center Align"><span
                  className="glyphicon glyphicon-align-center" aria-hidden="true"/>
                </button>
                <button type="button" className="btn btn-default" aria-label="Right Align"><span
                  className="glyphicon glyphicon-align-right" aria-hidden="true"/>
                </button>
                <button type="button" className="btn btn-default" aria-label="Justify"><span
                  className="glyphicon glyphicon-align-justify" aria-hidden="true"/>
                </button>
              </div>
            </div>
            <div className="btn-toolbar" role="toolbar">
              <button type="button" className="btn btn-default btn-lg"><span className="glyphicon glyphicon-star"
                                                                             aria-hidden="true"/> Star
              </button>
              <button type="button" className="btn btn-default"><span className="glyphicon glyphicon-star"
                                                                      aria-hidden="true"/> Star
              </button>
              <button type="button" className="btn btn-default btn-sm"><span className="glyphicon glyphicon-star"
                                                                             aria-hidden="true"/> Star
              </button>
              <button type="button" className="btn btn-default btn-xs"><span className="glyphicon glyphicon-star"
                                                                             aria-hidden="true"/> Star
              </button>
            </div>
          </div>
          ...
          <div className="highlight">
<pre><code className="language-html" data-lang="html"><span className="nt">&lt;button</span> <span
  className="na">type=</span><span className="s">"button"</span> <span className="na">class=</span><span className="s">"btn btn-default"</span> <span
  className="na">aria-label=</span><span className="s">"Left Align"</span><span className="nt">&gt;</span>
  <span className="nt">&lt;span</span> <span className="na">class=</span><span className="s">"glyphicon glyphicon-align-left"</span> <span
    className="na">aria-hidden=</span><span className="s">"true"</span><span className="nt">&gt;&lt;/span&gt;</span>
<span className="nt">&lt;/button&gt;</span>

<span className="nt">&lt;button</span> <span className="na">type=</span><span className="s">"button"</span> <span
    className="na">class=</span><span className="s">"btn btn-default btn-lg"</span><span className="nt">&gt;</span>
  <span className="nt">&lt;span</span> <span className="na">class=</span><span
    className="s">"glyphicon glyphicon-star"</span> <span className="na">aria-hidden=</span><span
    className="s">"true"</span><span className="nt">&gt;&lt;/span&gt;</span> Star
<span className="nt">&lt;/button&gt;</span></code></pre>
          </div>

          <p>An icon used in an <a href="#alerts">alert</a> to convey that it's an error message, with
            additional <code>.sr-only</code> text to convey this hint to users of assistive technologies.</p>
          ...
          <div className="highlight">
<pre><code className="language-html" data-lang="html"><span className="nt">&lt;div</span> <span
  className="na">class=</span><span className="s">"alert alert-danger"</span> <span className="na">role=</span><span
  className="s">"alert"</span><span className="nt">&gt;</span>
  <span className="nt">&lt;span</span> <span className="na">class=</span><span className="s">"glyphicon glyphicon-exclamation-sign"</span> <span
    className="na">aria-hidden=</span><span className="s">"true"</span><span className="nt">&gt;&lt;/span&gt;</span>
  <span className="nt">&lt;span</span> <span className="na">class=</span><span className="s">"sr-only"</span><span
    className="nt">&gt;</span>Error:<span className="nt">&lt;/span&gt;</span>
